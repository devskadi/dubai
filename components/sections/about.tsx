    ...
    >
      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="grid grid-cols-2 gap-10 items-stretch">
          ...
          >
            <p className="font-heading text-xl uppercase font-semibold tracking-wider text-dark-800">
              About Us
            </p>
            <h2 className="font-title text-5xl font-bold leading-tight">
              <span className="text-dark-900">20+ Years of</span><br />
              <span className="text-accent-500">Business Excellence</span>
            </h2>
          </motion.div>
